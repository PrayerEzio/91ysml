                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <a href="{{ url('/Admin/Attribute/addCategory') }}"><i class="fa fa-plus"></i> 新增</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($list as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <a class="btn btn-success" href="{{ url('/Admin/Attribute/attributeList',['id'=>$item->id]) }}"><i class="fa fa-barss"></i> 查看属性</a>
                                        <a class="btn btn-info" href="{{ url('/Admin/Attribute/editCategory',['id'=>$item->id]) }}"><i class="fa fa-edit"></i> 编辑</a>
