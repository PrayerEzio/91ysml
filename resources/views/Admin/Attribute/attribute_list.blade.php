                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <a href="{{ url('/Admin/Attribute/addAttribute') }}"><i class="fa fa-plus"></i> 新增</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" onclick="delete_attribute({{ $item->id }})"><i class="fa fa-trash"></i> 删除</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <script>
        function delete_attribute(id)
        {
            swal({
                ...
                var URL = '{{ url('Admin/Attribute/deleteAttribute') }}';
