                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <a href="{{ url('Admin/Auth/permission_create') }}"><i class="fa fa-plus"></i> 新增</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($permission_list as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{ url('Admin/Auth/permission_edit',['id'=>$permission->id]) }}"><i class="fa fa-edit"></i> 编辑</a>
    ...
    <script>
        function delete_permission(id)
        {
            swal({
                ...
                var URL = '{{ url('Admin/Auth/permission_delete') }}';
