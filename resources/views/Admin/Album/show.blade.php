                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="{{ url('Admin/AlbumPicture/create') }}">新增相片</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <div class="file">
                                                ...
                                                <div class="file-name">
                                                    ...
                                                    <div class="small text-center">
                                                        <button class="btn btn-info btn-xs" onclick="window.location.href='{{ url("/Admin/AlbumPicture/{$item->id}/edit") }}'"><i class="fa fa-edit"></i> 编辑</button>
    ...
    <script>
        function delete_picture(id)
        {
            swal({
                ...
                var URL = '{{ url('Admin/AlbumPicture') }}/'+id;
