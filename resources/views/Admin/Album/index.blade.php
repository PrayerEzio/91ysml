                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="{{ url('Admin/Album/create') }}">创建相册</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="lightBoxGallery">
                                    @foreach($list as $item)
                                        <div class="file-box" id="item_{{ $item->id }}">
                                            <div class="file">
                                                <a href="{{ url("/Admin/Album/{$item->id}") }}">
                                                    ...
                                                    <div class="file-name">
                                                        ...
                                                        <div class="small text-center">
                                                            <a class="btn btn-info btn-xs" href="{{ url("/Admin/Album/{$item->id}/edit") }}"><i class="fa fa-edit"></i> 编辑</a>
