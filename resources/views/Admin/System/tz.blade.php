...
<table>
  ...
  <tr>
    ...
    <?php echo (preg_match("/phpinfo/i",$disFuns))? '<font color="red">×</font>' :"<a href='{{ url('Admin/System/phpinfo') }}' target='_blank'>PHPINFO</a>";?>
...
<a name="w_performance"></a><a name="bottom"></a>
	...
	<table>
		<tr>
			<td class="w_foot"><A HREF="http://www.Yahei.Net" target="_blank"><?php echo $title;?></A></td>
