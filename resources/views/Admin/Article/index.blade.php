                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="ibox">
                            <div class="ibox-content">
                                <a href="{{ url('/Admin/Article/edit',['id'=>$article->id]) }}" class="btn-link">
                                    <h2>
                                        {{ $article->title }}
                                    </h2>
                                </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="small text-right">
                                            <h5>操作：</h5>
                                            <a class="btn btn-info btn-xs" href="{{ url('/Admin/Article/edit',['id'=>$article->id]) }}"><i class="fa fa-edit"></i> 编辑</a>
